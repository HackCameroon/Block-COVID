...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    // Load CryptoSwap
    const CrypticData = CryptoSwap.networks[networkId]
    if(CrypticData) {
      const cryptoswap = new web3.eth.Contract(CryptoSwap.abi, CrypticData.address)
  ...
  buyTokens = (etherAmount) => {
    ...
    this.state.cryptoswap.methods.buyTokens().send({ value: etherAmount, from: this.state.account }).on('transactionHash', (hash) => {
      this.setState({ loading: false })
    })
  }
